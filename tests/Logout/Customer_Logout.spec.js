...
test('Test customer logout', async ({ page }) => {
...
//Confirm that the customer is logged out by verifying the empty email textbox in the sign in page

    //Confirm the log in button is displayed at the top right
    await expect(page.locator('#root > div > header > ul > li.block > a')).toContainText(/Log In/);
