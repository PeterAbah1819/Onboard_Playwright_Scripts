...
test('Test customer settings confirm page items', async ({ page }) => {
...
test('Test customer add bank payment methods invalid, incomplete, empty and valid account number', async ({ page }) => {
    await page.goto('https://app.dev.onboardpay.co/auth/sign-in');
...
//Test add payment methods invalid account number
    ...
    await page.locator('#headlessui-combobox-input-11').click();
    await page.locator('#headlessui-combobox-input-11').fill('Access');
...
//Test add payment methods valid account number
    ...
    await page.locator('#headlessui-combobox-input-11').click();
    await page.locator('#headlessui-combobox-input-95').fill('polaris');
...
test('Test customer add wallet payment methods invalid, incomplete, empty and valid account number', async ({ page }) => {
    await page.goto('https://app.dev.onboardpay.co/auth/sign-in');
...
//Add wallet payment method by clicking on the add payment method button
    ...
    await page.locator('#headlessui-listbox-button-129').click();
...
test('Test customer edit bank payment methods invalid, incomplete, empty and valid account number', async ({ page }) => {
    await page.goto('https://app.dev.onboardpay.co/auth/sign-in');
...
//Test edit payment methods invalid account number
    ...
    //Enter acccess bank as financial institution
    await page.locator('#headlessui-combobox-input-11').click();
    await page.locator('#headlessui-combobox-input-11').press('Meta+a');
    await page.locator('#headlessui-combobox-input-11').fill('Access');
    await page.getByRole('option', { name: 'Access Bank' }).click();
    //Click on save
    await page.getByRole('button', { name: 'Save' }).click();
...
test('Test customer edit wallet payment methods invalid, incomplete, empty and valid account number', async ({ page }) => {
    await page.goto('https://app.dev.onboardpay.co/auth/sign-in');
...
test('Test customer delete payment method', async ({ page }) => {
    await page.goto('https://app.dev.onboardpay.co/auth/sign-in');
